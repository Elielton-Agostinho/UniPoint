import getDisciplina from '../services/Professor';
import getPonto from '../services/disciplinas';
import podeMarcar from '../services/DisciplinaLib';
...
export async function AptoMarcacao(matricula,disciplina,cd_disciplina){
    
    var disc = "0";
    try { 
        disc = await podeMarcar(matricula,disciplina,cd_disciplina);
    } catch (error) {
